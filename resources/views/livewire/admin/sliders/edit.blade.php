            ...
            @endif
                ...
                <div class="form-group">
                    ...
                    <select wire:model.lazy='style'>
                        <option value="1" @if($style == '1') selected @endif>1</option>
                        <option value="2" @if($style == '2') selected @endif>2</option>
                        <option value="3" @if($style == '3') selected @endif>3</option>
                    </select>
